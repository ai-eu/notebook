...
- Volume control next to the player: a button opens a vertical slider (the native control is mute-only on some browsers); the level is remembered between visits.
